...
int main() {
    ...
    while(japa!=0) {
        ...
        printf("||1 - Catalago               ||\n");
        printf("||2 - Historico              ||\n");
        printf("||3 - Salvar Data Base em CSV||\n");
        printf("||0 - Sair                   ||\n");
        printf("::===========================::\n");
        ...
        switch (opcao1) {
            case 1:
                ...
                printf("||3 - Listar ranqueadas pelo IMDB ||\n");
                printf("||4 - Pesquisar série pelo codigo ||\n");
                printf("||5 - Pesquisar série pelo titulo ||\n");
                printf("||6 - Alterar série               ||\n");
                printf("||7 - Excluir série               ||\n");
                printf("||8 - Pesquisar série pelo Genero ||\n");
                printf("||0 - Voltar                      ||\n");
                printf("::================================::\n");
                printf("Digite uma opção:\n");
                scanf("%d", &opcao2);
                ...
                case 5://Pesquisar série
                    ...
                    printf("\nTop %d no ranking de popularidade do imdB\n",found->ranking); //printa ranking
                    printf("\nnota: %.2f\n",found->rating); //printa rating
